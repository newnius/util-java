...
public class CRSpider {
    ...
    /*
    *
    * more mime-type can be found in http://www.iana.org/assignments/media-types/media-types.xhtml
    *
    * */
    ...
    * */
    ...
    /*
    * user-agent(optional)
    * more user-agent can be found in http://www.useragentstring.com
    * */
